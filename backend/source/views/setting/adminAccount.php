...
<div class="row">
    <div class="col-xs-12">
        <div class="form">
            ...
            <?php endif; ?>
            <div class="form-group">
                <?php echo $form->label($model, Yii::t('common', 'label.adminFullname'), array('class'=>'control-label')); ?>
                <?php echo $form->textField($model,'adminFullname', array(
                    'type'=>'text',
                    'class'=>'form-control',
                )); ?>
                <?php echo $form->error($model,'adminFullname'); ?>
            </div>
