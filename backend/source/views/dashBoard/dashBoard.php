    ...
    <div class="col-xs-12">
        <div class="row">
            ...
            <div class="col-xs-8 text-right">
                ...
                <div class="form-group">
                    <!--Type:--> <select id="type" name="type" class="form-control">
                ...
                <button type="button" onclick='onReportClicked();' class="btn btn-default" style="height: 29px">Report</button>
                <?php $this->endWidget(); ?>
            </div>
        </div>
