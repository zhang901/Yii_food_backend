...
<div class="form">
    ...
    <?php endif; ?>
    <div class="form-group">
        <?php echo $form->label($model, Yii::t('common', 'label.cookingMethodName'), array('class'=>'control-label')); ?>
    ...
    <div class="form-group">
        <?php echo $form->label($model, Yii::t('common', 'label.cookingMethodDesc'), array('class'=>'control-label')); ?>
    ...
    <div class="form-group">
        ...
        <?php echo $form->textField($model, 'cmOrderNumber', array(
            'type'=>'text',
            'class'=>'form-control',
        ));?>
        <?php echo $form->error($model,'cmOrderNumber'); ?>
    </div>
