...
class TableSeatsController extends Controller
{
	/**
	...
	{
		$model=new TableSeats;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['TableSeats']))
		{
			$model->attributes=$_POST['TableSeats'];
			if($model->save())
	...
	{
		$model=new TableSeats('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TableSeats']))
			$model->attributes=$_GET['TableSeats'];
	 ...
	 * @return TableSeats the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TableSeats::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TableSeats $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='table-seats-form')
		{
